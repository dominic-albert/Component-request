...
>(({ index, className, ...props }, ref) => (
  <div
    ...
    className={cn(
      ...
      "[&:has([data-selected])]:bg-accent [&:has([data-selected])]:text-accent-foreground [&:has([data-highlighted])]:bg-accent [&:has([data-highlighted])]:text-accent-foreground [&:has([data-selected])]:ring-ring",
      className,
    )}
    {...props}
  >
